	...
	<div class="container">
        ...
        <div class="name">
            ...
            <div class="count">Сегодня <i>
                ...
                $special_select =$pdo->prepare('SELECT MAX(order_id) AS order_id FROM orders_buy');
        ...
        <div class="calculate">
            ...
            <div class="obm">
                ...
                <a href="intropage2.php"><img src="img/button-exchange_blue2.gif" class="gif" onmouseover="this.src='img/button-exchange_blue1.gif'" onmouseout="this.src='img/button-exchange_blue2.gif'"></a>
                <div class="bl2">
                    <h5>Get</h5>
